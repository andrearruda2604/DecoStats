            ...
            <div className="border-t border-outline-variant/50 pt-3">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-3 text-[8px] font-bold text-on-surface-variant/60">
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-sm bg-blue-500 inline-block" /> Mais</span>
                    ...
                    <div key={line} className={`flex items-center gap-2 rounded-lg px-1 py-1.5 ${anyIs100 ? 'bg-amber-400/5' : ''}`}>
                      ...
                      <div className="flex-1 flex flex-col gap-0.5">
                        <div className="flex items-center h-7 rounded overflow-hidden bg-white/8">
                          ...
                          {homeUnder > 0 && (
                            <div
                              className="h-full bg-rose-500 flex items-center justify-center transition-all duration-500"

      ...
      >
        ...
        <div className="bg-surface/40 backdrop-blur-xl border border-outline-variant/20 rounded-3xl p-8 shadow-2xl">
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-bold text-sm py-3.5 px-6 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl"
          >
